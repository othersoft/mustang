...
void VisualizeBoard(BOARD *B){
  ...
  "                                                                               \n"
  "    +---+---+---+---+---+---+---+---+        +---+---+---+---+---+---+---+---+ \n"
  " 8  | %c | %c | %c | %c | %c | %c | %c | %c |     1  | %c | %c | %c | %c | %c | %c | %c | %c |\n"
  "    +---+---+---+---+---+---+---+---+        +---+---+---+---+---+---+---+---+ \n"
  " 7  | %c | %c | %c | %c | %c | %c | %c | %c |     2  | %c | %c | %c | %c | %c | %c | %c | %c |\n"
  "    +---+---+---+---+---+---+---+---+        +---+---+---+---+---+---+---+---+ \n"
  " 6  | %c | %c | %c | %c | %c | %c | %c | %c |     3  | %c | %c | %c | %c | %c | %c | %c | %c |\n"
  "    +---+---+---+---+---+---+---+---+        +---+---+---+---+---+---+---+---+ \n"
  " 5  | %c | %c | %c | %c | %c | %c | %c | %c |     4  | %c | %c | %c | %c | %c | %c | %c | %c |\n"
  "    +---+---+---+---+---+---+---+---+        +---+---+---+---+---+---+---+---+ \n"
  " 4  | %c | %c | %c | %c | %c | %c | %c | %c |     5  | %c | %c | %c | %c | %c | %c | %c | %c |\n"
  "    +---+---+---+---+---+---+---+---+        +---+---+---+---+---+---+---+---+ \n"
  " 3  | %c | %c | %c | %c | %c | %c | %c | %c |     6  | %c | %c | %c | %c | %c | %c | %c | %c |\n"
  "    +---+---+---+---+---+---+---+---+        +---+---+---+---+---+---+---+---+ \n"
  " 2  | %c | %c | %c | %c | %c | %c | %c | %c |     7  | %c | %c | %c | %c | %c | %c | %c | %c |\n"
  "    +---+---+---+---+---+---+---+---+        +---+---+---+---+---+---+---+---+ \n"
  " 1  | %c | %c | %c | %c | %c | %c | %c | %c |     8  | %c | %c | %c | %c | %c | %c | %c | %c |\n"
  "    +---+---+---+---+---+---+---+---+        +---+---+---+---+---+---+---+---+ \n"
  "                                                                             \n"
  ...
  B->matrix[0][7], B->matrix[0][6], B->matrix[0][5], B->matrix[0][4],   
  B->matrix[0][3], B->matrix[0][2], B->matrix[0][1], B->matrix[0][0],
  ...
  B->matrix[1][7], B->matrix[1][6], B->matrix[1][5], B->matrix[1][4],
  B->matrix[1][3], B->matrix[1][2], B->matrix[1][1], B->matrix[1][0],
  ...
  B->matrix[2][7], B->matrix[2][6], B->matrix[2][5], B->matrix[2][4],
  B->matrix[2][3], B->matrix[2][2], B->matrix[2][1], B->matrix[2][0],
  ...
  B->matrix[3][7], B->matrix[3][6], B->matrix[3][5], B->matrix[3][4],
  B->matrix[3][3], B->matrix[3][2], B->matrix[3][1], B->matrix[3][0],
  ...
  B->matrix[4][7], B->matrix[4][6], B->matrix[4][5], B->matrix[4][4],
  B->matrix[4][3], B->matrix[4][2], B->matrix[4][1], B->matrix[4][0],
  ...
  B->matrix[5][7], B->matrix[5][6], B->matrix[5][5], B->matrix[5][4],
  B->matrix[5][3], B->matrix[5][2], B->matrix[5][1], B->matrix[5][0],
  ...
  B->matrix[6][7], B->matrix[6][6], B->matrix[6][5], B->matrix[6][4],
  B->matrix[6][3], B->matrix[6][2], B->matrix[6][1], B->matrix[6][0],
